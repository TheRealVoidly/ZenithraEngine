...
int* zenithra_object_ray_intersects_detection(float origin[3], struct ObjectData **obj, struct InEngineData *engine_data_str){
    ...
    float length = sqrtf(engine_data_str->MOVE->direction_look[0]*engine_data_str->MOVE->direction_look[0] + engine_data_str->MOVE->direction_look[1]*engine_data_str->MOVE->direction_look[1] + 1.0f);
    ...
    float *v0 = &obj[0]->vertex_buffer_data[0];
    float *v1 = &obj[0]->vertex_buffer_data[3];
    float *v2 = &obj[0]->vertex_buffer_data[6];
    ...
    float distance = t * sqrt(dir[0]*dir[0] + dir[1]*dir[1] + dir[2]*dir[2]);
    float temp = distance;
